...
describe('[Resolvers.blocks]', () => {
    ...
    beforeAll(() => {
        ...
        mock.mockReturnValue(new Promise(resolve => resolve(blocksAPIResponse)));
    });
    ...
    it('should return only first 10 elements', async () => {
        ...
        expect(response).toEqual(blocksAPIResponse.slice(0, 10));
    ...
    it('should return only elements at index 2, 3', async () => {
        ...
        expect(response).toEqual(blocksAPIResponse.slice(1, 3));
    });
});
